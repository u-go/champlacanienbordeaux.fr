...
<header class="blog-header py-3">
  ...
  <div class="col-md-12" style="height: 200px; width: 100%; background-image:url(<?php bloginfo("template_directory"); ?>/fond.jpeg); background-size: contain; backround-repeat: no-repeat">
  </div>
</header>